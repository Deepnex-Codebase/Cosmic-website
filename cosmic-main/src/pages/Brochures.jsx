      ...
      >
        <div className="container mx-auto px-4">
          <div className="max-w-4xl">
            ...
            >
              In current market scenario solar power is most reliable and sustainable source of energy. 
                          ...
                          >
                            ...
                            <td className="px-6 py-4 whitespace-nowrap">
                              <div className="flex items-center text-sm text-gray-900">
                                <FaRupeeSign className="text-[#9fc22f] mr-1" />
                            ...
                            <td className="px-6 py-4">
                              <div className="text-sm text-gray-900 max-w-xs">
                                <p className="truncate" title={rate.description}>
                                  {rate.description}
                                </p>
                              </div>
                            </td>
                                  ...
                                  <div className="space-y-1">
                                    {rate.features.slice(0, 2).map((feature, featureIndex) => (
                                      <div key={featureIndex} className="flex items-start">
                                        <FaCheckCircle className="text-[#9fc22f] mt-0.5 mr-1 flex-shrink-0 text-xs" />
                            ...
                            <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                              <div className="flex space-x-2">
                                <button
                                  ...
                                  className="inline-flex items-center px-3 py-1 border border-transparent text-xs leading-4 font-medium rounded-md text-white bg-[#9fc22f] hover:bg-[#8aaa28] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#9fc22f] transition-colors duration-200"
                                >
                                  <FaEye className="mr-1" />
                                  View
                                </button>
                                <button
                                  ...
                                  className="inline-flex items-center px-3 py-1 border border-gray-300 text-xs leading-4 font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#9fc22f] transition-colors duration-200"
                                >
                                  <FaFileDownload className="mr-1" />
                                  Download
                                </button>
