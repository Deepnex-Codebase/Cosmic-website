    ...
    >
      ...
      {isMobile && (
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <button
            ...
            style={{
              width: videoHeroData.buttonSettings.mobileSize.width,
              height: videoHeroData.buttonSettings.mobileSize.height,
      ...
      {!isMobile && (
        <button
          ...
          style={{
            width: videoHeroData.buttonSettings.desktopSize.width,
            height: videoHeroData.buttonSettings.desktopSize.height,
            backgroundColor: videoHeroData.buttonSettings.backgroundColor,
