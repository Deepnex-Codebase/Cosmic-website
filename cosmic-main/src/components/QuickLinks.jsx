    ...
    <section className="py-20 bg-white overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-6 md:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          {/* Newsletter Signup */}
          {(!loading && !error && footerConfig?.newsletter?.isActive) ? (
            <div className="bg-[#142334] rounded-2xl p-8 md:p-10 relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
                  {footerConfig.newsletter.title || 'Subscribe to Our Newsletter'}
                </h2>
                <p className="text-white/80 mb-8 max-w-md">
                  {footerConfig.newsletter.description || 'Get the latest news, tips, and updates on solar technology, industry trends, and exclusive offers delivered to your inbox.'}
                </p>
                ...
                <form className="space-y-4" onSubmit={handleNewsletterSubmit}>
                  <div>
                    ...
                    <input 
                      ...
                      placeholder={footerConfig.newsletter.placeholder || "Enter your email"} 
                  ...
                  <button 
                    type="submit" 
                    disabled={newsletterStatus === 'subscribing'}
                    className="bg-[#cae28e] hover:bg-[#a7cb50] text-black font-medium px-6 py-3 rounded-lg transition-colors flex items-center group hover-glow disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <span>
